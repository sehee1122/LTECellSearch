...
#define CONFIG_HLP_SSB_INDEX	 "decide ssb index\n"
#define CONFIG_HLP_HALF_FRAME	 "decide half frame\n"
...
{"ssb-index" , 				 	CONFIG_HLP_SSB_INDEX,  0,		 iptr:&cfg_ssb_index,					 defintval:-1,					 TYPE_INT,		 0},					 \
{"half-frame" ,                  CONFIG_HLP_HALF_FRAME,  0,         iptr:&cfg_nhf,                   defintval:-1,                    TYPE_INT,       0}                     \
}
