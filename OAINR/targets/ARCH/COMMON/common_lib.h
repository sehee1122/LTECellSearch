...
struct openair0_device_t {
  ...
  */   
  ...
  int (*adjust_rx_freq_func)(openair0_device *device, openair0_config_t *openair0_cfg);

  int (*trx_configure_on)(openair0_device *device, openair0_config_t *openair0_cfg);
};
