...
typedef struct {
  ...
  int ssb_symbol_offset; //number of symbols that the PBCH exists from frame boundary
  int ssb_slot_offset; //number of symbols that the PBCH exists from frame boundary
  UE_nr_proc_t proc;
